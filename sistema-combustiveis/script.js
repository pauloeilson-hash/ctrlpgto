...
function adicionarAbastecimento(e) {
    ...
    // CORREÇÃO: Garantir que a data seja salva exatamente como informada
    // Sem conversões de fuso horário
    ...
    const novoAbastecimento = {
        ...
        data: dataSelecionada, // Usar a data diretamente, sem conversão
...
function atualizarEstatisticasVeiculo(veiculoId) {
    ...
    // CORREÇÃO: Ordenar por data sem problemas de fuso horário
...
function atualizarTabelaAbastecimentos() {
    ...
    // CORREÇÃO: Ordenar por data (mais recente primeiro) sem problemas de fuso
...
function formatarData(data) {
    // CORREÇÃO: Usar a data diretamente sem conversão de fuso horário
    // Se a data já está no formato YYYY-MM-DD, converter para pt-BR
    if (data.includes('-')) {
